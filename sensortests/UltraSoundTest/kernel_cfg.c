/*
 *  kernel_cfg.c
 *  Tue Dec 03 12:02:18 2013
 *  SG Version 2.00
 *  sg.exe ultrasoundtest.oil -os=ECC2 -IC:/Users/Dan/Dropbox/Uni/Projekter/P5/P5SVN/Software/nxtOSEK/toppers_osek/sg/impl_oil -template=C:/Users/Dan/Dropbox/Uni/Projekter/P5/P5SVN/Software/nxtOSEK/toppers_osek/sg/lego_nxt.sgt
 */
...
const TaskType TestTask = 1;

extern void TASKNAME( InitializeTask )( void );
extern void TASKNAME( TestTask )( void );

static __STK_UNIT _stack_priority_3[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_priority_4[__TCOUNT_STK_UNIT(512)];

const Priority tinib_inipri[TNUM_TASK] = { TPRI_MINTASK + 4, TPRI_MINTASK + 3, };
const Priority tinib_exepri[TNUM_TASK] = { TPRI_MAXTASK, TPRI_MAXTASK, };
const UINT8 tinib_maxact[TNUM_TASK] = { (1) - 1, (1) - 1, };
const AppModeType tinib_autoact[TNUM_TASK] = { 0x00000001, 0x00000000, };
const FP tinib_task[TNUM_TASK] = { TASKNAME( InitializeTask ), TASKNAME( TestTask ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_priority_4, (__STK_UNIT)_stack_priority_3, };
...
const AlarmType cyclic_alarm_TestTask = 0;

DeclareTask(TestTask);
static void _activate_alarm_cyclic_alarm_TestTask( void );
static void _activate_alarm_cyclic_alarm_TestTask( void )
{ (void)ActivateTask( TestTask ); }

const CounterType alminib_cntid[TNUM_ALARM] = { 0, };
const FP alminib_cback[TNUM_ALARM] = { _activate_alarm_cyclic_alarm_TestTask, };
