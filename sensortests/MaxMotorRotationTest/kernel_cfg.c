/*
 *  kernel_cfg.c
 *  Fri Oct 25 11:50:19 2013
 *  SG Version 2.00
 *  sg.exe maxmotorrotationtest.oil -os=ECC2 -IC:/Lego_Project/nxtOSEK/toppers_osek/sg/impl_oil -template=C:/Lego_Project/nxtOSEK/toppers_osek/sg/lego_nxt.sgt
 */
...
const TaskType DriveTask = 0;

extern void TASKNAME( DriveTask )( void );

static __STK_UNIT _stack_DriveTask[__TCOUNT_STK_UNIT(512)];
...
const FP tinib_task[TNUM_TASK] = { TASKNAME( DriveTask ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_DriveTask, };
...
const AlarmType cyclic_alarm_DriveTask = 0;

DeclareTask(DriveTask);
static void _activate_alarm_cyclic_alarm_DriveTask( void );
static void _activate_alarm_cyclic_alarm_DriveTask( void )
{ (void)ActivateTask( DriveTask ); }

const CounterType alminib_cntid[TNUM_ALARM] = { 0, };
const FP alminib_cback[TNUM_ALARM] = { _activate_alarm_cyclic_alarm_DriveTask, };
const AppModeType alminib_autosta[TNUM_ALARM] = { 0x00000001, };
const TickType alminib_almval[TNUM_ALARM] = { 1, };
const TickType alminib_cycle[TNUM_ALARM] = { 1000, };
